<template>
  <nav class="fixed w-full p-6 bg-transarent blur-xl z-40">
    <div class="flex items-center justify-between">
      <div class="">
        <Tailwind />
        <!-- <div class="h-full w-40" style="background-image: url(https://logodix.com/logo/48986.jpg);"></div> -->
      </div>
      ...
      <!-- 
      <div class="hidden md:w-1/3 flex justify-center">
        <div class="" style="background-image: url();">HEJ</div>
      </div> -->

      <!-- NavBar -->
      <div class="hidden md:block text-gray-200 text-lg flex justify-end">
        <ul class="flex space-x-8 font-sans flex justify-end">
          <li>
            <nuxt-link
              to="/"
              class=""
